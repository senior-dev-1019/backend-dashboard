...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">@lang('dashboard.invoices.create-invoice')</li>
    </ol>
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-table mr-1"></i>@lang('dashboard.invoices.create-invoice')</div>
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.invoices.store') }}">
                @csrf
                @if (session('success'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="invoice_date" value="{{ old('invoice_date') }}" type="text" step="any" class="form-control date-picker @error('invoice_date') is-invalid @enderror" name="invoice_date" required autocomplete="name" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="payment_date" value="{{ old('payment_date') }}" type="text" class="form-control date-picker @error('payment_date') is-invalid @enderror" name="payment_date" autocomplete="payment_date" autofocus>
