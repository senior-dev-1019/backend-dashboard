            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="postcode" class="col-md-4 col-form-label text-md-right">@lang('auth.postcode')</label>
                        ...
                        <div class="form-group row">
                            <label for="city" class="col-md-4 col-form-label text-md-right">@lang('auth.city')</label>
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right">@lang('auth.mobile')</label>
