...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">@lang('dashboard.patients.edit-patient')</li>
    </ol>
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-table mr-1"></i>@lang('dashboard.patients.edit-patient')</div>
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.patients.update', [$patient->id]) }}">
                @csrf
                @if (session('success'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="date_of_birth" type="text" class="form-control date-picker @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ $patient->date_of_birth }}" autocomplete="date_of_birth" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="patient_number" type="text" class="form-control @error('patient_number') is-invalid @enderror" name="patient_number" value="{{ $patient->patient_number }}" autocomplete="patient_number" autofocus>
                    ...
                    <div class="col-md-6">
                        <select name="institution_id" id="institution_id" class="form-control @error('institution_id') is-invalid @enderror">
                            ...
                            @foreach($institutions as $institution)
                                <option value="{{ $institution->id }}" {{ $patient->institution_id === $institution->id ? "selected" : "" }}>{{ $institution->name }}</option>
                            @endforeach
                        </select>
