...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">@lang('dashboard.subscriptions.create-subscription')</li>
    </ol>
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-table mr-1"></i>@lang('dashboard.subscriptions.create-subscription')</div>
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.subscriptions.store') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="title" value="{{ old('title') }}" type="text" class="form-control @error('title') is-invalid @enderror" name="title" required autocomplete="title" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="description" value="{{ old('description') }}" type="text" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="description" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="monthly_price" value="{{ old('monthly_price') }}" type="number" step="any" class="form-control @error('monthly_price') is-invalid @enderror" name="monthly_price" required autocomplete="name" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="has_timeline" id="has_timeline" class="form-control @error('has_timeline') is-invalid @enderror">
                            <option value="0" {{ old('has_timeline') == 0 ? "selected" : "" }}>No</option>
                            <option value="1" {{ old('has_timeline') == 1 ? "selected" : "" }}>Yes</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="has_documents" id="has_documents" class="form-control @error('has_documents') is-invalid @enderror">
                            <option value="0" {{ old('has_documents') == 0 ? "selected" : "" }}>No</option>
                            <option value="1" {{ old('has_documents') == 1 ? "selected" : "" }}>Yes</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="has_institution" id="has_institution" class="form-control @error('has_institution') is-invalid @enderror">
                            <option value="0" {{ old('has_institution') == 0 ? "selected" : "" }}>No</option>
                            <option value="1" {{ old('has_institution') == 1 ? "selected" : "" }}>Yes</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="provisions" value="{{ old('provisions') }}" type="number" step="any" class="form-control @error('provisions') is-invalid @enderror" name="provisions" required autocomplete="name" autofocus>
